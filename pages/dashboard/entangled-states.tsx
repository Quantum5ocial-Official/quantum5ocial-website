...
function EntangledStatesRightSidebar() {
  return (
    <aside
...
export default function EntangledStatesPage() {
  ...
  const entangledCount = profiles.length + followedOrgs.length;
  ...
  return (
    <section className="section">
      ...
      <section style={{ marginTop: 24 }}>
        ...
        <div style={{ marginTop: 12, overflowX: "auto", paddingBottom: 4 }}>
          {orgsLoading ? (
            ...
            <div style={{ display: "flex", gap: 12, minHeight: 170, paddingRight: 8 }}>
      ...
      <section style={{ marginTop: 28 }}>
        ...
        {errorMsg && (
          <p style={{ marginTop: 12, fontSize: 13, color: "#f97373" }}>
            {errorMsg}
          </p>
        )}
      </section>
...
(EntangledStatesPage as any).layoutProps = {
  variant: "three",
  right: <EntangledStatesRightSidebar />,
};
