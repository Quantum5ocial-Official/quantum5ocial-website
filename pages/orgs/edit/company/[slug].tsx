...
export default function EditCompanyPage() {
  ...
  // auto-update slug from name ONLY if user hasn't touched slug (not used here, but keep behaviour)
  useEffect(() => {
    ...
    try {
      ...
      const { data, error } = await supabase
        ...
        .update({
          ...
          // later you can also update logo_url once upload is wired
        })
        .eq("id", orgId)
      ...
      <div className="page">
        ...
        >
          <header style={{ marginBottom: 24 }}>
            ...
            >
              Update how your company, startup, or vendor appears on
              Quantum5ocial.
            </p>
          </header>
          ...
          {loadingOrg ? (
            ...
            >
              ...
              {/* Logo upload (still just UI, same as create) */}
              <div>
                <label
                  htmlFor="org-logo"
                  style={{
