    ...
    <section className="section" style={{ paddingTop: 24, paddingBottom: 48 }}>
      ...
      >
        <header style={{ marginBottom: 24 }}>
          ...
          <p style={{ fontSize: 15, opacity: 0.8, maxWidth: 640 }}>
        ...
        >
          ...
          <Link href="/orgs/create/company" className="org-type-card-link">
            ...
            >
              ...
              >
                <div
                  style={{
                    ...
                    background: "linear-gradient(135deg, #3bc7f3cc, #8468ffcc)",
                    color: "#0f172a",
                    fontSize: 22,
                    fontWeight: 600,
              ...
              <span style={{ fontSize: 15, fontWeight: 500, color: "#7dd3fc" }}>
                Get started →
              </span>
            </div>
          </Link>
          ...
          <Link href="/orgs/create/research-group" className="org-type-card-link">
            ...
            >
              ...
              >
                <div
                  style={{
                    ...
                    alignItems: "center",
                    justifyContent: "center",
                    background: "linear-gradient(135deg, #a855f7cc, #3b82f6cc)",
                    color: "#0f172a",
                    fontSize: 22,
                    fontWeight: 600,
              ...
              >
                For labs, institutes, and research collaborations that want a
                simple profile to link people, projects, and job opportunities.
              </p>

              <span style={{ fontSize: 15, fontWeight: 500, color: "#c084fc" }}>
                Get started →
              </span>
            </div>
          </Link>
...
(CreateOrganizationLanding as any).layoutProps = {
  variant: "two-left",
  right: null,
};
