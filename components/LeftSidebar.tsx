...
import Q5BadgeChips from "./Q5BadgeChips"; // ✅ NEW
...
type ProfileSummary = {
  ...
  // ✅ NEW (already mirrored into profiles by your claim modal)
...
export default function LeftSidebar() {
  ...
  // ✅ NEW: badge props (rendered via shared component)
    ...
    <aside className="layout-left sticky-col" style={{ display: "flex", flexDirection: "column", gap: 6 }}>
      ...
      >
        <div className="profile-sidebar-header">
          {/* ✅ Avatar wrapper becomes positioning context for top-right badge */}
          <div style={{ position: "relative", width: 56, height: 56, flexShrink: 0 }}>
            ...
            {/* ✅ Badge pinned to TOP-RIGHT of avatar */}
            <div
              style={{
                position: "absolute",
                top: 0,
